...
WS_REPLY_TIMEOUT = 60
WS_IDLE_TIMEOUT = 60
WS_IDLE_TIMEOUT_REASONING = 120
REASONING_MODEL_MARKERS = ("-r1", "reasoning", "-think")
DIRECT_WS_RETRIES = 3
EMPTY_REPLY_RETRIES = 3
DIRECT_WS_BACKOFF = 0.5
DIRECT_WS_BACKOFF_CAP = 4.0
USEAI_RESUME_RETRIES = 2
BROWSER_FALLBACK_ENABLED = False
ACCOUNT_POOL_SIZE = 1000
ACCOUNT_POOL_REFILL_SEC = 0.5
ACCOUNT_TTL_SEC = 600
ACCOUNT_BATCH_SIZE = 50
ACCOUNT_BATCH_CONCURRENCY = 80
DIRECT_MAX_CONCURRENCY = 200
